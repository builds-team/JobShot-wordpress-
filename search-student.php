...
function scout_test_func(){
  /*
  global $wpdb;
  $query = 
"SELECT user_id
FROM wp_146219050_usermeta
WHERE 1=1
AND( wp_146219050_usermeta.meta_key = 'gender'
AND wp_146219050_usermeta.meta_value LIKE '%男性%' )";
  ...
  */
  ...
  $students=new WP_User_Query( $args );//get_users($args);
 var_dump($students->get_results());
}
add_shortcode('scout_test','scout_test_func');
